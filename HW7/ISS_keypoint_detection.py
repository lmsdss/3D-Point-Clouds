...
if __name__ == '__main__':
    point_cloud = np.genfromtxt(r"car_0001.txt", delimiter=",")  # bed_0001.txt airplane_0001.txt
    point_cloud = point_cloud[:, 0:3]  # x y z

    feature_idx = iss(point_cloud) # iss计算特征点的序号
    feature_point = point_cloud[feature_idx] # 特征点
